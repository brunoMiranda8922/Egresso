...
require_once("banco/funcoes.4.php");
...
?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Alunos Transporte Terrestre</h3>
                ...
                <div class="col-12 col-md-9">
                    <form class="form-header" action="transporteTerrestre.php" method="GET">
