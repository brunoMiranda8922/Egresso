...
function listarAlunos($conexao)
{
    ...
    $query_alunos = "SELECT DISTINCT f.id,  f.RA, f.cpf, f.nome, f.email, c.nome AS curso, ano_formacao AS ano, 
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
            ORDER BY ano_formacao DESC limit {$inicio}, {$quantidade_pagina}";
...
function listarAlunosPorPesquisa($conexao)
{
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
             WHERE f.nome LIKE '%$valor_pesquisar%' OR f.RA LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC, RA LIMIT {$inicio}, {$quantidade_pagina}";
...
function listarAlunosPorAno($conexao)
{
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
             WHERE f.ano_id = '{$filtrar}' ORDER BY ano_formacao DESC, RA LIMIT {$inicio}, {$quantidade_pagina}";
...
function listarAlunosPorPesquisaAndAno($conexao)
{
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
             WHERE f.ano_id = '{$filtrar}' AND f.nome LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC";
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
             WHERE f.ano_id = '{$filtrar}' AND f.nome LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC, RA LIMIT {$inicio}, {$quantidade_pagina}";
...
function listarAlunosPorPesquisaAndCurso($conexao)
{
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN
        cursos AS c ON f.cursos_id = c.id INNER JOIN ano ON f.ano_id = ano.id INNER JOIN
            semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
                WHERE f.cursos_id = '{$curso}' AND f.nome LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC";
    $resultado_aluno = mysqli_query($conexao, $query);
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
                WHERE f.cursos_id = '{$curso}' AND f.nome LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC, RA LIMIT {$inicio}, {$quantidade_pagina}";
...
function listarAlunosPorPesquisaAndAnoAndCuso($conexao)
{
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN
        cursos AS c ON f.cursos_id = c.id INNER JOIN ano ON f.ano_id = ano.id INNER JOIN
            semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
                WHERE f.cursos_id = '{$curso}' AND f.ano_id = '{$filtrar}' AND f.nome LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC";
    $resultado_aluno = mysqli_query($conexao, $query);
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
                WHERE f.cursos_id = '{$curso}' AND f.ano_id = '{$filtrar}' AND f.nome LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC, RA LIMIT {$inicio}, {$quantidade_pagina}";
...
function paginarlistarAlunosPorPesquisa($conexao)
{
    ...
    data_semestre AS semestre, ci.nome AS cidade, f.PR from egressos AS f INNER JOIN cursos AS c ON f.cursos_id = c.id
        INNER JOIN ano ON f.ano_id = ano.id INNER JOIN semestre ON f.semestre_id = semestre.id INNER JOIN cidade AS ci ON f.cidade_id = ci.id
             WHERE f.nome LIKE '%$valor_pesquisar%' ORDER BY ano_formacao DESC";
