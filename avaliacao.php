                        ...
                        <div class="row m-t-30">
                            <div class="col-md-12">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        $contar = count($respostas); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="process text-center"><?= $resposta['sexo'] ?></td>
                                                <td class="process text-center"><?= $avaliacao[$resposta['formacao']] ?></td>
                                                <td class="process text-center"><?= $avaliacao[$resposta['cronograma']] ?></td>
                                                <td class="process text-center"><?= $avaliacao[$resposta['professores']] ?></td>
                                                <td class="process text-center"><?= $avaliacao[$resposta['infraestrutura']] ?></td>
                                                <td class="process text-center"><?= $recomendariaa[$resposta['recomendaria']] ?></td>
                                                <td class="process text-center"><?= $simOuNao[$resposta['estagio']] ?></td>
                                                <td class="process text-center"><?= $resposta['semestre'] ?></td>
                                ...
                                <nav aria-label="pagination-lg" class="text-center">
                                    ...
                                    <a class="btn btn-primary" href="avaliacao.php?pagina=<?= $pagina_anterior; ?>" aria-label="Previous">
                                    ...
                                    <?php 
                                        ...
                                        for ($i = 1; $i < $quantidade_paginas + 1; $i++) { 
                                            if ($pagina == $i) { ?>
                                    <a class="btn btn-warning" href="avaliacao.php?pagina=<?= $i ?>"><?= $i ?></a></li>
                                    <?php } else { ?>  
                                    <a class="btn btn-secondary" href="avaliacao.php?pagina=<?= $i ?>"><?= $i ?></a></li>
                                    <?php  } 
                                    } 
                                    ?>
                                    ...
                                    <a class="btn btn-primary" href="avaliacao.php?pagina=<?=  $pagina_posterior; ?>" aria-label="Previous">
