                    ...
                    <nav aria-label="pagination-lg" class="text-center">
                        ...
                        <?php
                            ...
                            for ($i = 1; $i < $quantidade_paginas + 1; $i++) {
                                if ($pagina == $i) {
                        ?>
                                <a class="btn btn-warning" href="avaliacao.php?pagina=<?= $i ?>"><?= $i ?></a>
                            <?php
                                } else {
                            ?>
                                <a class="btn btn-secondary" href="avaliacao.php?pagina=<?= $i ?>"><?= $i ?></a>
                            <?php
                                }
                            }
                            ?>
                        ...
                        ?>
                            <a class="btn btn-primary" href="avaliacao.php?pagina=<?=  $pagina_posterior; ?>" aria-label="Previous"><span aria-hidden="true">Proxima</span></a>
                        <?php
                            } else {
                        ?>
                            <span aria-hidden="true"></span>
