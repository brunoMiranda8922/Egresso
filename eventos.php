                ...
                ?>
                    ...
                    <?php
                        if ($pagina_anterior != 0) { ?>
                            <a class="btn btn-primary" href="eventos.php?pagina=<?= $pagina_anterior; ?><?= $valor_pesquisar ?><?= $ano_id ?>" aria-label="Previous"><span aria-hidden="true">Voltar</span></a>
                    <?php
                        } else {
                    ?>
                    ...
                    <?php
                        if ($quantidade_paginas = paginarTrabalha($conexao));
                            for ($i = 1; $i < $quantidade_paginas + 1; $i++) {
                                if($pagina == $i) {
                    ?>
                                <a class="btn btn-danger" href="eventos.php?trabalha=<?= $i ?><?= $valor_pesquisar ?>"><?= $i ?></a>
                            <?php
                                } else {
                            ?>
                                <a class="btn btn-secondary" href="eventos.php?trabalha=<?= $i ?><?= $valor_pesquisar ?>"><?= $i ?></a>
                            <?php
                                }
                            }
                        ?>
                            ...
                            <?php
                                if($pagina_posterior <= $quantidade_paginas){ ?>
                                    <a class="btn btn-primary" href="eventos.php?pagina=<?=  $pagina_posterior; ?>" aria-label="Previous"><span aria-hidden="true">Proxima</span></a>
                            <?php
                                } else {
                            ?>
                                <span aria-hidden="true"></span>
