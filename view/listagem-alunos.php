                                    ...
                                    <table class="table table-borderless table-data3 ">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="frequencia-alunos.php?id=<?= $aluno['id']?>&RA=<?= $aluno['RA']?>" class="btn btn-success" role="button" aria-label="Ver frequência do aluno"><i aria-hidden="true">Frequencia</i> </td>
                                                <td>
