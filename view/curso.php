...
?>
    ...
    <div class="main-content">
        <div class="section__content section__content--p30">
            ...
            <form action="../controller/cadastrar-curso.php" id="contact_form" method="POST" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                        ...
                        <?php $curso = listarCurso($conexao);
                            foreach($curso as $cursos) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="../controller/deletar-cursos.php" method="POST">
