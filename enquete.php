                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <form action="cadastroQuestionario.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="form-check">
                                            <div class="radio">
                                                <label for="radio1" class="form-check-label ">
                                                    <input type="radio" onclick="undisable()"  name="trabalha"  value="sim"  class="form-check-input" required/>Sim
                                                </label>
                                            ...
                                            <div class="radio">
                                                <label for="radio2" class="form-check-label ">
                                                    <input type="radio" onclick="disable()"  name="trabalha" value="nao" class="form-check-input"/>Não
                                                </label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text1" name="empresa"  placeholder="Nome da Empresa" class="form-control" >
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="area" id="text2" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id ="text3" name="cargo"  placeholder="Titulo do Cargo" class="form-control">
                                            <small class="help-block form-text">preencha somente se já estiver trabalhando</small>
                                        </div>
                                ...
                                <div class="container-fluid">       
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                        <p class="form-control-static-"> possui ótimos professores</p>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                        <p class="form-control-static-"> da Fatec atende as demandas do curso</p>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-9">
                                            <div class="form-check-inline form-check">
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 1 </small><input type="radio"  name="recomendaria" value="1" class="form-check-input" required> 
                                                </label>

                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 2 </small><input type="radio"  name="recomendaria" value="2" class="form-check-input"> 
                                                </label>
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 3 </small> <input type="radio"  name="recomendaria" value="3" class="form-check-input"> 
                                                </label>
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 4 </small> <input type="radio"  name="recomendaria" value="4" class="form-check-input"> 
                                                </label>
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 5 </small>   <input type="radio"  name="recomendaria" value="5" class="form-check-input"> 
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-9">
                                            <div class="form-check-inline form-check">
                                                ...
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> Não  </small><input type="radio"  name="estagio" value="2" class="form-check-input"> 
                                                </label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-9">
                                            <div class="form-check-inline form-check">
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 1 </small><input type="radio"  name="semestre" value="6" class="form-check-input" required> 
                                                </label>

                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 2 </small><input type="radio"  name="semestre" value="7" class="form-check-input"> 
                                                </label>
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 3 </small> <input type="radio"  name="semestre" value="8" class="form-check-input"> 
                                                </label>
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 4 </small> <input type="radio"  name="semestre" value="9" class="form-check-input"> 
                                                </label>
                                                <label  class="form-check-label ">
                                                <small class="help-block form-text"> 5 </small>   <input type="radio"  name="semestre" value="10" class="form-check-input"> 
                                                </label>
                                            </div>
                                        </div>
                                    </div>
